...
df_receber = ler_planilha_por_id("Financeiro_contas_a_receber_Born")
df_pagar = ler_planilha_por_id("Financeiro_contas_a_pagar_Born")
...
planilha_saida = client.open_by_key(planilhas_ids["Financeiro_Completo_Born"])
